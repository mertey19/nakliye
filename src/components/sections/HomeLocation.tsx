...
export function HomeLocation() {
  ...
  return (
    <div className="mt-12 border-t border-line pt-10 sm:mt-14 sm:pt-12">
      <div className="grid overflow-hidden rounded-card border border-line bg-card lg:grid-cols-[minmax(0,1.45fr)_minmax(300px,0.55fr)]">
        <iframe
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            {hasGbp && (
              <a
                ...
                className="inline-flex min-h-[48px] items-center justify-center rounded-[10px] border border-line bg-surface px-5 py-3 text-center font-semibold text-white transition-colors hover:border-ink-500 hover:bg-card"
              >
            ...
            <Link
              href="/iletisim"
              className="inline-flex min-h-[44px] items-center justify-center text-[14px] font-bold text-white underline decoration-1 underline-offset-4 transition-colors hover:text-ink-500"
            >
